...
import {GlobalOutlined,FormOutlined} from '@ant-design/icons';
 const  NormalCards = (dataSet)=>{
    console.log("dattaset",dataSet)

    return(
        <>
         <Card  bordered={true} style={{   borderTop:" 4px solid #18C438",borderBottom:" 0px solid  #AFAFAF",borderLeft:" 0px solid  #AFAFAF",borderRight:" 0px solid  #AFAFAF",width:"400px"}}>
